        ...
        <div class="card card-body mb5">
            <form  action="../includes/insert.php" style="height: 400px;" method="POST">
                ...
                <div class="mb-3 col-5" id="iden">
                    ...
                    <input type="num" class="form-control" id="txt6" name="ident" maxlength="11">
                </div>
        ...
        <table class="table table-wrapper table-striped table-bordered table-lg" id="contendortabla2" cellspacing="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a nom="<?php echo $row['Nombre']?>" ap="<?php echo $row['APP']?>" 
                            am="<?php echo $row['APM']?>" tel="<?php echo $row['Telefono']?>"
                            cor="<?php echo $row['Correo']?>" identi="<?php echo $row['Identificacion']?>" tipiden="<?php echo $row['tipo_identificacion']?>"
