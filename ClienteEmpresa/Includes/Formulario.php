...
<div class="container border" style="position: absolute; top: 100px; left: 500px;width: 800px;height: 100px;"><br>
    <div class="container" id="contendortabla">
        <input class="form-control" type="text" id="myInput" onkeyup="myFunction()" placeholder="Buscar RUC"
            style="width: 750px;" title="Digita una Variedad"><br>
        <div class="container">
        <table class="table table-bordered" id="contendortabla2" cellspacing="0">
            <thead style="position: absolute;" >
                <tr>
                    <th style="width: 122px;">Empresa</th>
                    <th style="width: 95px;">Telefono</th>
                    <th style="width: 184px;">Correo</th>
                    <th style="width: 112px;">RUC</th>
                ...
                <tr>
                    ...
                    <td style="width: 30px;">
                        <a  empre="<?php echo $row['Empresa']?>" tele="<?php echo $row['Telefono']?>"
                            ...
                            href="#" class="btn btn-secondary edit_emp"
